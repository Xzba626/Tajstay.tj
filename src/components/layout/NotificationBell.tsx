    ...
    <div className={cn("relative", className)} ref={ref}>
      ...
      {open ? (
        <div className="absolute right-0 top-full z-[120] mt-2 w-[min(100vw-1.5rem,24rem)] overflow-hidden rounded-2xl border border-slate-200/90 bg-white shadow-2xl ring-1 ring-black/5">
          <div className="border-b border-slate-100 bg-gradient-to-r from-[#ecfdf5] to-white px-4 py-3">
              ...
              <div className="flex items-center gap-2">
                ...
                {unreadCount > 0 ? (
                  <button
                    ...
                    className="text-xs font-medium text-[#0f7a4d] hover:underline disabled:opacity-50"
                  >
                    {labels.markReadAll}
                  </button>
                ) : null}
                    ...
                    >
                      ...
                      <span className="min-w-0 flex-1">
                        <span className="flex items-start justify-between gap-2">
                          ...
                          {!n.isRead ? <span className="mt-1 h-2 w-2 shrink-0 rounded-full bg-[#0f7a4d]" /> : null}
                        </span>
