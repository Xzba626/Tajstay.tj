...
const ru: Tree = {
  ...
  profile: {
    ...
    contactEmailHint: "Укажите email и нажмите «Сохранить».",
    ...
    errEmailSend: "Не удалось отправить код на email.",
    errEmailCode: "Неверный или просроченный код.",
    errTelegramCode: "Неверный или просроченный код.",
    errTooManyAttempts: "Слишком много попыток. Попробуйте позже.",
...
const tg: Tree = {
  ...
  profile: {
    ...
    contactEmailHint: "Email-ро ворид кунед ва «Захира кардан»-ро пахш кунед.",
    ...
    errPhotoRequired: "Суратро интихоб кунед.",
    errEmailSend: "Рамз ба email фиристода нашуд.",
    errEmailCode: "Рамз нодуруст ё анҷомёфта.",
    errTelegramCode: "Рамз нодуруст ё анҷомёфта.",
    errTooManyAttempts: "Кӯшишҳо зиёд. Баъдтар кӯшиш кунед.",
    ...
    changePhoto: "Тағйири сурат",
    newName: "Номи нав",
    newSurname: "Насаби нав",
...
const en: Tree = {
  ...
  profile: {
    ...
    contactEmailHint: "Enter your email and tap Save.",
    ...
    errEmailSend: "Could not send the code to email.",
    errEmailCode: "Invalid or expired code.",
    errTelegramCode: "Invalid or expired code.",
    errTooManyAttempts: "Too many attempts. Try later.",
