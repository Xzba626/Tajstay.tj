...
const ru: Tree = {
  ...
  auth: {
    ...
    telegramRegisterHint: "Новый аккаунт создаётся автоматически после подтверждения в боте",
    telegramOpenBot: "Открыть бота TajStay",
    telegramWaitingBot: "Откройте бота и нажмите Start",
    telegramAwaitingConfirm: "Подтвердите вход в боте",
    telegramConfirmed: "Вход подтверждён…",
    telegramExpired: "Время истекло — начните снова",
    telegramStep1: "1. Откройте Telegram и нажмите Start у бота",
    telegramStep2: "2. Нажмите «Подтвердить вход» или отправьте код из бота",
...
const tg: Tree = {
  ...
  auth: {
    ...
    telegramRegisterHint: "Ҳисоби нав пас аз тасдиқ дар бот эҷод мешавад",
    telegramOpenBot: "Боти TajStay-ро кушоед",
    telegramWaitingBot: "Ботро кушоед ва Start-ро пахш кунед",
    telegramAwaitingConfirm: "Вурудро дар бот тасдиқ кунед",
    telegramConfirmed: "Вуруд тасдиқ шуд…",
    telegramExpired: "Вақт анҷом ёфт — аз нав оғоз кунед",
    telegramStep1: "1. Telegram-ро кушоед ва дар бот Start-ро пахш кунед",
    telegramStep2: "2. «Вурудро тасдиқ кардан»-ро пахш кунед ё рамзро фиристед",
...
const en: Tree = {
  ...
  auth: {
    ...
    telegramRegisterHint: "A new account is created automatically after you confirm in the bot",
    telegramOpenBot: "Open TajStay bot",
    telegramWaitingBot: "Open the bot and tap Start",
    telegramAwaitingConfirm: "Confirm sign-in in the bot",
    telegramConfirmed: "Sign-in confirmed…",
    telegramExpired: "Expired — please start again",
    telegramStep1: "1. Open Telegram and tap Start in the bot",
    telegramStep2: "2. Tap Confirm sign-in or send the code from the bot",
