...
const ru: Tree = {
  ...
  auth: {
    ...
    telegramTooManyAttempts: "Слишком много попыток. Начните вход заново.",
...
const tg: Tree = {
  ...
  auth: {
    ...
    telegramTooManyAttempts: "Кӯшишҳо зиёд шуданд. Вурудро аз нав оғоз кунед.",
...
const en: Tree = {
  ...
  auth: {
    ...
    telegramTooManyAttempts: "Too many attempts. Start sign-in again.",
